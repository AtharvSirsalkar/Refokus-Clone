  ...
  return (
    <div className="w-full mt-10">
      <div className="max-w-screen-xl mx-auto relative">
        <h1 className="text-[30vw] leading-none select-none text-center font-medium tracking-tight">
          Work
        </h1>
          ...
          {images.map(
            (elem, index) =>
              elem.isActive && (
                <img
                  key={index}
                  className="w-60 ease-out duration-100 rounded-lg absolute -translate-x-[50%] -translate-y-[50%]  "
